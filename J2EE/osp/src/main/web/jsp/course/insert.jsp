    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="courseName" value="" required lay-verify="required"
                       placeholder="请输入课程名"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="introduction" value="" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="note" value="" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['layer', 'form', 'jquery'], function () {
        ...
        form.on('submit(form)', function (data) {
            ...
            $.ajax({
                       url: '${pageContext.request.contextPath}/course/insert_course',
                       data: {
