    ...
    <div class="footer-container">
          ...
          <div class="footer-link">      
            ...
            <div class="footer-copyright">     
              <p>
                <img draggable="false" class="moco-emoji" alt="©" src="../assets/a9.png">
              &nbsp;2020&nbsp;diecolor.com&nbsp;&nbsp;苏ICP备13030149号-1
              <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=32010202010179" target="_blank" style="color:#93999F;font-size:12px;margin:0 5px !important;">
              <i class="beian"></i>苏公网安备32010202010179号</a> 
...
.footer-sns a {
    ...
    background-image: url(../assets/idx-btm.png);
...
.footer-sns-weixin i {
    ...
    left: -77px;
    bottom: 40px;
    background: url(../assets/elevator.png) no-repeat 0 0;
}
.footer .footer-sns p {
    font-size: 12px;
    color: #4D555D;
...
.footer .beian {
    background: url(../assets/beianicon.png) no-repeat 0 0;
    width: 16px;
    height: 16px;
    vertical-align: middle;
